  ...
  <main class="auth-wrap">
    <div class="card auth-card shadow-sm">
      <div class="card-body p-4">
        ...
        <h1 class="h5 mb-3">Registrazione utente</h1>
        <?php if ($done): ?>
          ...
          <form method="post" novalidate>
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                <input class="form-control" id="first_name" name="first_name" value="<?php echo htmlspecialchars($first); ?>">
              </div>
              <div class="col-sm-6">
                <label class="form-label" for="last_name">Cognome</label>
                <input class="form-control" id="last_name" name="last_name" value="<?php echo htmlspecialchars($last); ?>">
              </div>
              <div class="col-12">
